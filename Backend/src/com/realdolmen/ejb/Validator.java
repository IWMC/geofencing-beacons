...
public interface Validator<E> {
     ...
     * (e.g. not null, passing a certain regex, ...).
     * This could be done using JPA validation, yet is not restricted to it.
     * The list of {@link Validation}s returned allows the integration of the validation in multi-platform and multilingual systems.
     *
