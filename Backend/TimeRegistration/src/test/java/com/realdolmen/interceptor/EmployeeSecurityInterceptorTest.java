...
public class EmployeeSecurityInterceptorTest {

    @InjectMocks
    private EmployeeSecurityInterceptor interceptor = new EmployeeSecurityInterceptor();
    ...
    @Test
    public void testInterceptorAcceptsOnEmployeeCredentialsJWT() throws Exception {
        configureJWT(true);
